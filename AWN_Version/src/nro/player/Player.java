    ...
    public short getLegThuCung() {
        ...
        return -1;
                    ...
                    public short getHead() {
                        ...
                        } else if (inventory != null && this.inventory.itemsBody != null && this.inventory.itemsBody.size() > 5 && inventory.itemsBody.get(5).isNotNullItem()) {
                            int headId = inventory.itemsBody.get(5).template.head;
                            if (headId > 0) {
                                return (short) headId;
                            }
                            if (inventory.itemsBody.get(5).template.part > 0) {
                                return (short) inventory.itemsBody.get(5).template.part;
                            }
                        }
                        return this.head;
                    }
                    ...
                    public short getBody() {
                        ...
                        if (inventory != null && inventory.itemsBody.get(5).isNotNullItem()) {
                            int ctId = inventory.itemsBody.get(5).template.id;
                            if (ctId == 2434) {
                                if (this.gender == ConstPlayer.NAMEC) {
                                    return 476; // Áo thần Namếc
                                } else if (this.gender == ConstPlayer.XAYDA) {
                                    return 474; // Áo thần Xayda
                                } else {
                                    return 472; // Áo thần Trái Đất
                                }
                            }
                    ...
                    public short getLeg() {
                        ...
                        if (effectSkill != null && effectSkill.iscumber) {
                            ...
                            if (ctId == 2434) {
                                if (this.gender == ConstPlayer.NAMEC) {
                                    return 477; // Quần thần Namếc
                                } else if (this.gender == ConstPlayer.XAYDA) {
                                    return 475; // Quần thần Xayda
                                } else {
                                    return 473; // Quần thần Trái Đất
                                }
                            }
        ...
        if (item != null && item.isNotNullItem()) {
            switch (item.template.id) {
                ...
                case 2059:
                    ...
                    break;
                case 2435:
                    aura = 51; // Susanoo Jiren
                    break;
                case 2436:
                    aura = 52; // Susanoo Gomah
                    break;
            }
        }
    }
